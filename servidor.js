...
"canadabosniayherzegovina": {
    ...
    diferenciaCasa:[
        ...
        { descripcion: "3", momio: 10.98 },
        { descripcion: "4", momio: 22.55 },
        { descripcion: "5", momio: 50.25 }
      ],

    diferenciaVisita: [
        { descripcion: "1", momio: 6.68 },
        { descripcion: "2", momio: 14.73 },
        { descripcion: "3", momio: 33.89 },
	{ descripcion: "4", momio: 116.03 }
      ],
...
"estadosunidosparaguay": {
    ...
    diferenciaCasa:[
        ...
        { descripcion: "3", momio: 12.02 },
        { descripcion: "4", momio: 27.22 },
        { descripcion: "5", momio: 61.24 }
      ],

    diferenciaVisita: [
        { descripcion: "1", momio: 6 },
        { descripcion: "2", momio: 13.89 },
        { descripcion: "3", momio: 33.89 },
	{ descripcion: "4", momio: 95.87 }
      ],
